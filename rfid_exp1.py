...
poly22=total_polygons[4].difference(total_polygons[8])
poly23=poly22.difference(total_polygons[3])
if(poly23.intersects(total_polygons[3])):
    print "ada ponga da neengalum unga project"
    poly2333=poly23.intersection(total_polygons[3])
    if poly2333.geom_type=="Polygon":
        print "Jeisthen"
    else:
        print "Jeichoooo"    
else:
